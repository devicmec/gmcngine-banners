...
var BannerFooter = function (_a) {
    ...
    var headerWidth = pageOrientation === "landscape" ? "11in" : "8.5in";
    return (React.createElement("div", { className: "banner-footer-container", style: { width: headerWidth } },
        React.createElement("div", { className: "banner-footer-phone-number-wrapper" },
            React.createElement("h3", { className: "banner-footer-ncmec-number" }, "CALL: 1-800-843-5678 (1-800-THE-LOST)"),
            React.createElement("h4", { className: "banner-footer-agency-number" }, "Lompoc Police Department (California) 1-805-736-2341")),
        React.createElement("div", { className: "banner-footer-gmcngine-logo" },
            React.createElement("img", { src: img$1, width: 105 }))));
};
...
var BannerCard = function (_a) {
    ...
    return (React.createElement("div", { className: "banner-card-container", style: dimensions }, children));
};
...
var AbductorsCard = function (_a) {
    ...
    return (React.createElement(BannerCard, { dimensions: cardDimensions },
        React.createElement("div", { className: "banner-abductor-card-content-wrapper" },
            React.createElement("div", { className: "banner-abductor-image-wrapper" },
                React.createElement("img", { src: abductorData.images[0] || no_photo_found, className: "banner-abductor-image", alt: "abductor" })),
...
function useCases() {
    var caseData = useContext(DataContext);
    return caseData;
}
...
var SingleChildPortraitBanner = function () {
    ...
    var handlePrint = useReactToPrint({ content: function () { return componentRef.current; } });
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { ref: componentRef, className: "scp-container" },
            React.createElement(BannerHeader, { bannerColor: "red", pageOrientation: "portrait" }),
            React.createElement(SingleChildPortraitBody, { caseData: data }),
            React.createElement(BannerFooter, { pageOrientation: "portrait" })),
        React.createElement("button", { onClick: handlePrint, style: {
                marginLeft: "100px",
...
var LandscapeChildCard = function (_a) {
    ...
    return (React.createElement(BannerCard, { dimensions: landscapeChildCardDimensions },
        React.createElement("div", { className: "mcl-card-content-wrapper" },
            React.createElement("div", { className: "mcl-image-wrapper" },
                React.createElement("img", { src: childData.images[0] || no_photo_found, className: "mcl-child-image", alt: "medium-child-card" })),
            React.createElement("div", { className: "mcl-card-details-container" },
...
var MultipleChildLandscapeBanner = function () {
    ...
    var handlePrint = useReactToPrint({ content: function () { return componentRef.current; } });
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "mcl-container", ref: componentRef },
            React.createElement(BannerHeader, { bannerColor: "red", pageOrientation: "landscape" }),
            React.createElement(MultipleChildLandscapeBody, { caseData: data }),
...
var MediumPortraitChildCard = function (_a) {
    ...
    return (React.createElement(BannerCard, { dimensions: mediumPortraitChildCardDimensions },
        React.createElement("div", { className: "mcp-md-card-content-wrapper" },
            React.createElement("div", { className: "mcp-md-image-wrapper" },
                React.createElement("img", { src: childData.images[0] || no_photo_found, className: "mcp-md-child-image", alt: "medium-child-card" })),
            React.createElement("div", { className: "mcp-md-card-details-container" },
                React.createElement("h2", null, childData.fullName),
...
var SmallPortraitChildCard = function (_a) {
    ...
    return (React.createElement(BannerCard, { dimensions: smallPortraitChildCardDimensions },
        React.createElement("div", { className: "mcp-sm-card-content-wrapper" },
            React.createElement("div", { className: "mcp-sm-image-wrapper" },
                React.createElement("img", { src: childData.images[0] || no_photo_found, className: "mcp-sm-child-image", alt: "medium-child-card" })),
            React.createElement("div", { className: "mcp-sm-card-details-container" },
                React.createElement("h2", null, childData.fullName),
...
var MultipleChildPortraitHeadline = function (_a) {
    ...
    return (React.createElement("div", { className: "mcp-headline-container" }, childrenAmount <= 3
        ? caseData.children.map(function (child, index) { return (React.createElement(MediumPortraitChildCard, { childData: child, key: child.childId + index })); })
        : caseData.children.map(function (child, index) { return (React.createElement(SmallPortraitChildCard, { childData: child, key: child.childId + index })); })));
};
...
var MultipleChildPortraitBanner = function () {
    ...
    var handlePrint = useReactToPrint({ content: function () { return componentRef.current; } });
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "mcp-container", ref: componentRef },
            React.createElement(BannerHeader, { bannerColor: "red", pageOrientation: "portrait" }),
            React.createElement(MultipleChildPortraitHeadline, { caseData: data }),
            React.createElement(MultipleChildPortraitDetails, { caseData: data }),
            React.createElement(BannerFooter, { pageOrientation: "portrait" })),
        React.createElement("button", { onClick: handlePrint, style: {
                marginLeft: "100px",
                backgroundColor: "green",
...
var SingleChildLandscapeBanner = function () {
    ...
    var handlePrint = useReactToPrint({ content: function () { return componentRef.current; } });
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "scl-container", ref: componentRef },
            React.createElement(BannerHeader, { bannerColor: "red", pageOrientation: "landscape" }),
...
var MissingBanners = function (_a) {
    ...
    function renderBanner() {
        ...
        var orientation = BannerToBeRendered === SingleChildPortraitBanner ||
            BannerToBeRendered === MultipleChildPortraitBanner
            ? "portrait"
            : "landscape";
        return (React.createElement(BannerToBeRendered, null,
            React.createElement("style", null, "@media print{\n          @page{\n            size: " + orientation + "\n          }\n        }")));
    }
    return (React.createElement(DataContext.Provider, { value: { data: data } },
        React.createElement("div", null, renderBanner())));
};
